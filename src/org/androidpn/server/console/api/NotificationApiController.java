...
//		return mav;
	...
	public void sendToOthers(String message, String exceptionUserName) throws Exception {
		String title = "client";

		String apiKey = Config.getString("apiKey", "");
		logger.debug("apiKey=" + apiKey);

		notificationManager.sendBroadcastToOthers(apiKey, title, message, "", exceptionUserName);
